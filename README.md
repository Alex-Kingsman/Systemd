...
11748 pts/0    T      0:00              _ sudo systemctl status [nginx@first.service](mailto:nginx@first.service)
11749 pts/1    Ss     0:00              |   _ sudo systemctl status [nginx@first.service](mailto:nginx@first.service)
11750 pts/1    T+     0:00              |       _ systemctl status [nginx@first.service](mailto:nginx@first.service)
...
11998 pts/0    T      0:00              _ sudo systemctl status [nginx@first.service](mailto:nginx@first.service)
11999 pts/3    Ss     0:00              |   _ sudo systemctl status [nginx@first.service](mailto:nginx@first.service)
12000 pts/3    T+     0:00              |       _ systemctl status [nginx@first.service](mailto:nginx@first.service)
12012 pts/0    T      0:00              _ sudo systemctl status [nginx@second.service](mailto:nginx@second.service)
12013 pts/4    Ss     0:00              |   _ sudo systemctl status [nginx@second.service](mailto:nginx@second.service)
12014 pts/4    T+     0:00              |       _ systemctl status [nginx@second.service](mailto:nginx@second.service)
12103 pts/0    T      0:00              _ sudo systemctl status [nginx@first.service](mailto:nginx@first.service)
12104 pts/5    Ss     0:00              |   _ sudo systemctl status [nginx@first.service](mailto:nginx@first.service)
12105 pts/5    T+     0:00              |       _ systemctl status [nginx@first.service](mailto:nginx@first.service)
12115 pts/0    T      0:00              _ sudo systemctl status [nginx@second.service](mailto:nginx@second.service)
12116 pts/6    Ss     0:00              |   _ sudo systemctl status [nginx@second.service](mailto:nginx@second.service)
12117 pts/6    T+     0:00              |       _ systemctl status [nginx@second.service](mailto:nginx@second.service)
